...
class Settings extends Model
{
    ...
    const exl = ["title"=>"Titel","content_en"=>"Text Englisch","blog_categories_id"=>"Kategorie",'title_en'=>"Titel Englisch",'users_id'=>"Autor","moderator_id"=>"Moderator","images_categories_id"=>"Bildergruppe","to_address"=>'Empfängeradresse','subject'=>'Betreff','pub'=>"Öffentlich",
                 ...
                 'name'=>"Name",'xis_aiImage'=>"Bild mit KI erstellt","blog_date" => "Öffentlich ab:","slug" => "URL","reading_time" => "Lesezeit","markdown_on" => "Markdown verwendet","blog_images_iid" => "Bildupload","updated_at" => "Letzte Änderung","first_name" => "Vorname","last_name" => "Nachname","email_verified_at" => "Email bestätigt","password" =>
...
"Status","message" => "Text","message_en" => "Text","camera_id" => "Kamera","link" => "Link","Format" => "Format","Format_en" => "Format Englisch","preis" => "Preis","tablename" => "Tabelle","xis_checked" => "checked","ordering" => "Podition","Longname" => "Langer Name","Mpixel" =>
