...
class RequestAdminStoreAndUpdateBlog extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules['blog_images_iid'] = ['required', 'exists:blog_images,id'];
    ...
    public function messages()
    {
        return [
            ...
            'blog_images_iid.required' => 'Bitte wähle ein Artikelbild aus.',
            'blog_images_iid.exists' => 'Das ausgewählte Artikelbild ist nicht vorhanden.',
