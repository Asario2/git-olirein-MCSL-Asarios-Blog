...
"Name Englisch","heading_alt" => "Überschrift","heading_alt_en" => "Überschrift Englisch","img_icon" => "Icon","AscName" => "AscName","AscName_en" => "AscName Englisch","description_en" => "Beschreibung Englisch","itemscope" => "ItemScope","xis_shopable" => "Verkäuflich","image_categories_id" => "Bilder Kategorie","status" =>
...
"Megapixel","short_tag" => "Tag","exif_copyright" => "Exif copy","admin_table_id"=>"Tabelle","exif_comp" => "exif Comp","exif_model" => "Exif Model"];
    ...
    const no_req = ['modul0','position','image_path','link','format','preis','format_en','music','interests','occupation','birthday','prename','xis_ai','id_new','exif_comp','exif_model'];
