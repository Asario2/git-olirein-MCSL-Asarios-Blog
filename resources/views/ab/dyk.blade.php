...
@section('content')
    <div class="container mt-5">
        <h2 class="text-center mb-4">Wussten Sie Schon?</h2>
                ...
                <div class="accordion-item">
                    ...
                    <h2 class="accordion-header" id="heading{{ $dat->id }}">
                        <button
                            ...
                            <span>Wussten Sie Schon {!! lcfirst(html_entity_decode($dat->headline)) !!}?</span>
                    ...
                    <div id="collapse{{ $dat->id }}" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body" style="font-size: 18px;">
                            {!! smilies(html_entity_decode($dat->answer)) !!}
                        </div>
                    </div>
                </div>
            @endforeach
