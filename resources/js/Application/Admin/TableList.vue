...
<template v-slot:datarow="data">
    ...
    <td class="np-dl-td-normal"><a :href="`/admin/tables/show/${data.datarow.full_name}`" class="text-blue-600 dark:text-blue-600 hover:underline">
    {{ data.datarow.table_name }}</a></td>
