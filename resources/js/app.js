...
import { route } from 'ziggy-js'; // Importiere den Route-Helper
...
import { faPencilAlt, faTrashCan } from '@fortawesome/free-solid-svg-icons';  // Importiere benötigte Icons

library.add(faPencilAlt, faTrashCan);  // Füge alle Icons zur Bibliothek hinzu
