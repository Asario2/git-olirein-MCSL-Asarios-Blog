            ...
            <template #content>
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div v-for="item in data" :key="item.id"  class="col-span-6 p-4 lg:rounded-lg">
                        ...
                        <div class="inline" style="float:left;padding-right:5px;margin-right:5px;"><img :src="'/images/_mfx/infos/thumbs/' + item.img_thumb" :alt="item.headline" :title="item.headline" class="inline lg:rounded-lg"/></div>
