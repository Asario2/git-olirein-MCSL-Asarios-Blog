...
const w = JSON.parse(
        '{"title":"Laravel 11 - Kickstart für Deine SaaS-Anwendungen","description":"","frontmatter":{},"headers":[],"relativePath":"book.md","filePath":"book.md"}',
    ),
    r = { name: "book.md" },
    s = e(
        "h1",
        {
            id: "laravel-11-kickstart-fur-deine-saas-anwendungen",
            tabindex: "-1",
        },
        [
            i("Laravel 11 - Kickstart für Deine SaaS-Anwendungen "),
            e(
                "a",
                {
                    class: "header-anchor",
                    href: "#laravel-11-kickstart-fur-deine-saas-anwendungen",
                    "aria-label":
                        'Permalink to "Laravel 11 - Kickstart für Deine SaaS-Anwendungen"',
                },
                "​",
            ),
        ],
    ...
    c = [s, d, u, l, o];
function g(h, k, f, p, b, _) {
    return a(), t("div", null, c);
}
const S = n(r, [["render", g]]);
